---
title: NGINX One Console Introduction
description: Introduction for the technical upskill session
order: 1
---
...
The "SDE NGINX One Console Upskilling" UDF blueprint contains all the prerequisites for this lab. This includes:
...
connectivity. If their security policies prohibits this, there is a product similar to the NGINX One Console called
...
customer metrics to F5 by default. You are able to disable this starting on NIM 2.18, by setting **Disconnected Mode**.
...
| IPs      | 3.135.72.139, 52.14.85.249, 3.133.232.50 |
...
Let's now make sure you can access the XC tenant, **f5-xc-lab-app**. When you brought up this UDF Blueprint, it also
provisions your access to XC using the email address used when logging into UDF. Let's confirm this on the next part
of this session by [clicking here](nginx-one-2.mdx).
