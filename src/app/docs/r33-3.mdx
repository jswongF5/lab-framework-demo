...
the a scenario where the NGINX Plus instance does not have internet connectivity but an NGINX Instance Manager
does have internet connectivity. [Click here](r33-4.mdx) to proceed to that.
