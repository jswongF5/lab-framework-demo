...
<Collapsible title="Instance details">
...
<Collapsible title="NGINX One Dashboard Details">
...
The next lab will be a Fix It Lab. [Click here](nginx-one-7.mdx) to proceed to that.
