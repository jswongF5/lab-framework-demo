---
title: Use Case 2 Interactive Lab
...
It is possible to remove NGINX instances from the Config Sync Group shown in the screenshot below.

> :warning: But doing this also removes the NGINX instance from being managed by NGINX One Console.
...
Let's proceed to the [Fix It Lab](nginx-one-8.mdx).
