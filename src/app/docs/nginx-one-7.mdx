...
You have now completed the labs for the *Managing NGINX Instance using NGINX One Console* use case.

Proceed to the next lab where we will go through [Config Sync Groups](nginx-one-8.mdx).
