---
title: NGINX One Console, Confirm XC Access
...
Cloud console (this may take 5-10min). You will be granted access to the
[f5-xc-lab-app](https://f5-xc-lab-app.console.ves.volterra.io) tenant.

The URL for this tenant in case you encounter an error with the workflow on this page:
...
1. Once redirected to the F5 Distributed Cloud console login, enter the lab tenant name, and click **Next**. Enter your email and password and click **Sign in**.
...
You now have access to the F5 Distribute Cloud Console! Lets now proceed to our first use case, *Managing NGINX Instance
using the NGINX One Console*. [Click here](nginx-one-3.mdx) to proceed to that.
