...
Watch me go through a demo where I will be adding and updating an NGINX instance. The instructions I am going though
is [here](nginx-one-1.mdx#connecting-to-the-console).
